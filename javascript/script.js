...
function updateTimer() {
  const targetDate = new Date("may 15, 2026 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '541169683617'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '541169683617'; // Número para el primer botón
